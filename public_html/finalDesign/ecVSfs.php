...
<script>
    ...
    function drawVisualization() {
        ...
        var data = google.visualization.arrayToDataTable([
            ['Population', 'Eastern Cape', {role: 'annotation'}, 'Free State', {role: 'annotation'}],
            ['', 6562053, '6 562 053', 2745590, '2 745 590']
        ]);
        var chart = new google.visualization.ColumnChart(document.getElementById('population'));
        var options = {
            title: "Population comparison: Eastern Cape VS Free State",
            legend: 'bottom',
...
<script>
    ...
    function drawVisualization() {
        ...
        var data = google.visualization.arrayToDataTable([
            ['Population', 'Eastern Cape', {role: 'annotation'}, 'Free State', {role: 'annotation'}],
            ['', 168966, '168 966', 129825, '129 825']
        ]);
        var chart = new google.visualization.ColumnChart(document.getElementById('size'));
        var options = {
            title: "Size comparison: Eastern Cape VS Free State",
            legend: 'bottom',
            colors: ['black', 'white', 'yellow', 'brown', 'blue', '#ffffff'],
            backgroundColor: 'gray',
            hAxis: {
...
<script>
    ...
    function drawVisualization() {
        // Create and populate the data table.
        var data = google.visualization.arrayToDataTable([
            ['Gender', 'Eastern Cape', {role: 'annotation'}, 'Free State', {role: 'annotation'}],
            ['Male', 47.1, '47.1%', 48.5, '48.5%'],
            ['Female', 52.9, '52.9%', 51.5, '51.5%']
        ]);
        var chart = new google.visualization.ColumnChart(document.getElementById('gender'));
        var options = {
            title: "Gender comparison: Eastern Cape VS Free State",
            legend: 'bottom',
            colors: ['black', 'white', 'yellow', 'brown', 'blue', '#ffffff'],
            backgroundColor: 'gray',
            hAxis: {
...
<script>
    ...
    function drawVisualization() {
        ...
        var options = {
            title: "Population Density comparison: Eastern Cape VS Free State",
            legend: 'bottom',
            colors: ['black', 'white', 'yellow', 'brown', 'blue', '#ffffff'],
            backgroundColor: 'gray',
            hAxis: {
...
<script>
    ...
    function drawVisualization() {
        // Create and populate the data table.
        var data = google.visualization.arrayToDataTable([
            ['Race', 'Eastern Cape', {role: 'annotation'}, 'Free State', {role: 'annotation'}],
            ['Black', 5663051, '5 663 051', 2405137, '2 405 137'],
            ['White', 308417, '308 417', 238866, '238 866'],
            ['Indian/Asian', 26248, '26 248', 10982, '10 982'],
            ['Coloured', 544650, '544 650', 85113, '85 113'],
            ['Other', 19686, '19 686', 8237, '8 237']
        ]);
        var chart = new google.visualization.ColumnChart(document.getElementById('race'));
        var options = {
            title: "Race comparison: Eastern Cape VS Free State",
            legend: 'bottom',
            colors: ['black', 'white', 'yellow', 'brown', 'blue', '#ffffff'],
            backgroundColor: 'gray',
            hAxis: {
...
<script>
    ...
    function drawVisualization() {
        ...
        var data = google.visualization.arrayToDataTable([
            ['Population', 'Eastern Cape', {role: 'annotation'}, 'Free State', {role: 'annotation'}],
            ['', 64539, 'R64 539', 75312, 'R75 312']
        ]);
        var chart = new google.visualization.ColumnChart(document.getElementById('income'));
        var options = {
            title: "Income comparison: Eastern Cape VS Free State",
            legend: 'bottom',
            colors: ['#BB3003', '#BC6C04', 'yellow', 'brown', 'blue', '#ffffff'],
            backgroundColor: 'gray',
            hAxis: {
                title: ""
            },
...
<script>
    ...
    function drawVisualization() {
        ...
        var options = {
            title: "Matric Pass Rate comparison: Eastern Cape VS Free State",
            legend: 'bottom',
            colors: ['black', 'white', 'yellow', 'brown', 'blue', '#ffffff'],
            backgroundColor: 'gray',
            hAxis: {
