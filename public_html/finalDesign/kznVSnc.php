...
<script>
    ...
    function drawVisualization() {
        ...
        var data = google.visualization.arrayToDataTable([
            ['Population', 'KwaZulu-Natal', {role: 'annotation'}, 'Northern Cape', {role: 'annotation'}],
            ['', 10267300, '10 267 300', 1145861, '1 145 861']
        ]);
        var chart = new google.visualization.ColumnChart(document.getElementById('population'));
        var options = {
            title: "Population comparison: KwaZulu-Natal VS Northern Cape",
            legend: 'bottom',
...
<script>
    ...
    function drawVisualization() {
        ...
        var data = google.visualization.arrayToDataTable([
            ['Population', 'KwaZulu-Natal', {role: 'annotation'}, 'Northern Cape', {role: 'annotation'}],
            ['', 94361, '94 361', 372889, '372 889']
        ]);
        var chart = new google.visualization.ColumnChart(document.getElementById('size'));
        var options = {
            title: "Size comparison: KwaZulu-Natal VS Northern Cape",
            legend: 'bottom',
            colors: ['black', 'white', 'yellow', 'brown', 'blue', '#ffffff'],
            backgroundColor: 'gray',
            hAxis: {
...
<script>
    ...
    function drawVisualization() {
        // Create and populate the data table.
        var data = google.visualization.arrayToDataTable([
            ['Gender', 'KwaZulu-Natal', {role: 'annotation'}, 'Northern Cape', {role: 'annotation'}],
            ['Male', 47.6, '47.6%', 49.2, '49.2%'],
            ['Female', 52.4, '52.4%', 50.8, '50.8%']
        ]);
        var chart = new google.visualization.ColumnChart(document.getElementById('gender'));
        var options = {
            title: "Gender comparison: KwaZulu-Natal VS Northern Cape",
            legend: 'bottom',
            colors: ['black', 'white', 'yellow', 'brown', 'blue', '#ffffff'],
            backgroundColor: 'gray',
            hAxis: {
...
<script>
    ...
    function drawVisualization() {
        ...
        var options = {
            title: "Population Density comparison: KwaZulu-Natal VS Northern Cape",
            legend: 'bottom',
            colors: ['black', 'white', 'yellow', 'brown', 'blue', '#ffffff'],
            backgroundColor: 'gray',
            hAxis: {
...
<script>
    ...
    function drawVisualization() {
        // Create and populate the data table.
        var data = google.visualization.arrayToDataTable([
            ['Race', 'KwaZulu-Natal', {role: 'annotation'}, 'Northern Cape', {role: 'annotation'}],
            ['Black', 8912016, '8 912 016', 577514, '577 514'],
            ['White', 431227, '431 227', 81356, '81 356'],
            ['Indian/Asian', 759780, '759 780', 8021, '8 021'],
            ['Coloured', 143742, '143 742', 461782, '461 782'],
            ['Other', 30802, '30 802', 18334, '18 334']
        ]);
        var chart = new google.visualization.ColumnChart(document.getElementById('race'));
        var options = {
            title: "Race comparison: KwaZulu-Natal VS Northern Cape",
            legend: 'bottom',
            colors: ['black', 'white', 'yellow', 'brown', 'blue', '#ffffff'],
            backgroundColor: 'gray',
            hAxis: {
...
<script>
    ...
    function drawVisualization() {
        ...
        var data = google.visualization.arrayToDataTable([
            ['Population', 'KwaZulu-Natal', {role: 'annotation'}, 'Northern Cape', {role: 'annotation'}],
            ['', 83053, 'R83 053', 86175, 'R86 175']
        ]);
        var chart = new google.visualization.ColumnChart(document.getElementById('income'));
        var options = {
            title: "Income comparison: KwaZulu-Natal VS Northern Cape",
            legend: 'bottom',
            colors: ['#B8BC06', '#9BBC05', 'yellow', 'brown', 'blue', '#ffffff'],
            backgroundColor: 'gray',
            hAxis: {
                title: ""
            },
...
<script>
    ...
    function drawVisualization() {
        ...
        var options = {
            title: "Matric Pass Rate comparison: KwaZulu-Natal VS Northern Cape",
            legend: 'bottom',
            colors: ['black', 'white', 'yellow', 'brown', 'blue', '#ffffff'],
            backgroundColor: 'gray',
            hAxis: {
