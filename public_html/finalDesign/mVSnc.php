...
<script>
    ...
    function drawVisualization() {
        ...
        var data = google.visualization.arrayToDataTable([
            ['Population', 'Mpumalanga', {role: 'annotation'}, 'Northern Cape', {role: 'annotation'}],
            ['', 4039939, '4 039 939', 1145861, '1 145 861']
        ]);
        var chart = new google.visualization.ColumnChart(document.getElementById('population'));
        var options = {
            title: "Population comparison: Mpumalanga VS Northern Cape",
            legend: 'bottom',
...
<script>
    ...
    function drawVisualization() {
        ...
        var data = google.visualization.arrayToDataTable([
            ['Population', 'Mpumalanga', {role: 'annotation'}, 'Northern Cape', {role: 'annotation'}],
            ['', 76495, '76 495', 372889, '372 889']
        ]);
        var chart = new google.visualization.ColumnChart(document.getElementById('size'));
        var options = {
            title: "Size comparison: Mpumalanga VS Northern Cape",
            legend: 'bottom',
            colors: ['black', 'white', 'yellow', 'brown', 'blue', '#ffffff'],
            backgroundColor: 'gray',
            hAxis: {
...
<script>
    ...
    function drawVisualization() {
        // Create and populate the data table.
        var data = google.visualization.arrayToDataTable([
            ['Gender', 'Mpumalanga', {role: 'annotation'}, 'Northern Cape', {role: 'annotation'}],
            ['Male', 49.0, '49.0%', 49.2, '49.2%'],
            ['Female', 51.0, '51.0%', 50.8, '50.8%']
        ]);
        var chart = new google.visualization.ColumnChart(document.getElementById('gender'));
        var options = {
            title: "Gender comparison: Mpumalanga VS Northern Cape",
            legend: 'bottom',
            colors: ['black', 'white', 'yellow', 'brown', 'blue', '#ffffff'],
            backgroundColor: 'gray',
            hAxis: {
...
<script>
    ...
    function drawVisualization() {
        ...
        var options = {
            title: "Population Density comparison: Mpumalanga VS Northern Cape",
            legend: 'bottom',
            colors: ['black', 'white', 'yellow', 'brown', 'blue', '#ffffff'],
            backgroundColor: 'gray',
            hAxis: {
...
<script>
    ...
    function drawVisualization() {
        // Create and populate the data table.
        var data = google.visualization.arrayToDataTable([
            ['Race', 'Mpumalanga', {role: 'annotation'}, 'Northern Cape', {role: 'annotation'}],
            ['Black', 3664225, '3 664 224', 577514, '577 514'],
            ['White', 302995, '302 995', 81356, '81 356'],
            ['Indian/Asian', 28280, '28 280', 8021, '8 021'],
            ['Coloured', 36359, '36 359', 461782, '461 782'],
            ['Other', 8080, '8 080', 18334, '18 334']
        ]);
        var chart = new google.visualization.ColumnChart(document.getElementById('race'));
        var options = {
            title: "Race comparison: Mpumalanga VS Northern Cape",
            legend: 'bottom',
            colors: ['black', 'white', 'yellow', 'brown', 'blue', '#ffffff'],
            backgroundColor: 'gray',
            hAxis: {
...
<script>
    ...
    function drawVisualization() {
        ...
        var data = google.visualization.arrayToDataTable([
            ['Population', 'Mpumalanga', {role: 'annotation'}, 'Northern Cape', {role: 'annotation'}],
            ['', 77609, 'R77 609', 86175, 'R86 175']
        ]);
        var chart = new google.visualization.ColumnChart(document.getElementById('income'));
        var options = {
            title: "Income comparison: Mpumalanga VS Northern Cape",
            legend: 'bottom',
            colors: ['#BB8B07', '#9BBC05', 'yellow', 'brown', 'blue', '#ffffff'],
            backgroundColor: 'gray',
            hAxis: {
                title: ""
            },
...
<script>
    ...
    function drawVisualization() {
        ...
        var options = {
            title: "Matric Pass Rate comparison: Mpumalanga VS Northern Cape",
            legend: 'bottom',
            colors: ['black', 'white', 'yellow', 'brown', 'blue', '#ffffff'],
            backgroundColor: 'gray',
            hAxis: {
