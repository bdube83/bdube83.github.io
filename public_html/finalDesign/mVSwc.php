...
<script>
    ...
    function drawVisualization() {
        ...
        var data = google.visualization.arrayToDataTable([
            ['Population', 'Mpumalanga', {role: 'annotation'}, 'Western Cape', {role: 'annotation'}],
            ['', 4039939, '4 039 939', 5822734, '5 822 734']
        ]);
        var chart = new google.visualization.ColumnChart(document.getElementById('population'));
        var options = {
            title: "Population comparison: Mpumalanga VS Western Cape",
            legend: 'bottom',
...
<script>
    ...
    function drawVisualization() {
        ...
        var data = google.visualization.arrayToDataTable([
            ['Population', 'Mpumalanga', {role: 'annotation'}, 'Western Cape', {role: 'annotation'}],
            ['', 76495, '76 495', 129462, '129 462']
        ]);
        var chart = new google.visualization.ColumnChart(document.getElementById('size'));
        var options = {
            title: "Size comparison: Mpumalanga VS Western Cape",
            legend: 'bottom',
            colors: ['black', 'white', 'yellow', 'brown', 'blue', '#ffffff'],
            backgroundColor: 'gray',
            hAxis: {
...
<script>
    ...
    function drawVisualization() {
        // Create and populate the data table.
        var data = google.visualization.arrayToDataTable([
            ['Gender', 'Mpumalanga', {role: 'annotation'}, 'Western Cape', {role: 'annotation'}],
            ['Male', 49.0, '49.0%', 49.0, '49.0%'],
            ['Female', 51.0, '51.0%', 51.0, '51.0%']
        ]);
        var chart = new google.visualization.ColumnChart(document.getElementById('gender'));
        var options = {
            title: "Gender comparison: Mpumalanga VS Western Cape",
            legend: 'bottom',
            colors: ['black', 'white', 'yellow', 'brown', 'blue', '#ffffff'],
            backgroundColor: 'gray',
            hAxis: {
...
<script>
    ...
    function drawVisualization() {
        ...
        var options = {
            title: "Population Density comparison: Mpumalanga VS Western Cape",
            legend: 'bottom',
            colors: ['black', 'white', 'yellow', 'brown', 'blue', '#ffffff'],
            backgroundColor: 'gray',
            hAxis: {
...
<script>
    ...
    function drawVisualization() {
        // Create and populate the data table.
        var data = google.visualization.arrayToDataTable([
            ['Race', 'Mpumalanga', {role: 'annotation'}, 'Western Cape', {role: 'annotation'}],
            ['Black', 3664225, '3 664 224', 1915679, '1 915 679'],
            ['White', 302995, '302 995', 914169, '914 169'],
            ['Indian/Asian', 28280, '28 280', 58227, '58 227'],
            ['Coloured', 36359, '36 359', 2841494, '2 841 494'],
            ['Other', 8080, '8 080', 93164, '93 164']
        ]);
        var chart = new google.visualization.ColumnChart(document.getElementById('race'));
        var options = {
            title: "Race comparison: Mpumalanga VS Western Cape",
            legend: 'bottom',
            colors: ['black', 'white', 'yellow', 'brown', 'blue', '#ffffff'],
            backgroundColor: 'gray',
            hAxis: {
...
<script>
    ...
    function drawVisualization() {
        ...
        var data = google.visualization.arrayToDataTable([
            ['Population', 'Mpumalanga', {role: 'annotation'}, 'Western Cape', {role: 'annotation'}],
            ['', 77609, 'R77 609', 143460, 'R143 460']
        ]);
        var chart = new google.visualization.ColumnChart(document.getElementById('income'));
        var options = {
            title: "Income comparison: Mpumalanga VS Western Cape",
            legend: 'bottom',
            colors: ['#BB8B07', '#7ABD03', 'yellow', 'brown', 'blue', '#ffffff'],
            backgroundColor: 'gray',
            hAxis: {
                title: ""
            },
...
<script>
    ...
    function drawVisualization() {
        ...
        var options = {
            title: "Matric Pass Rate comparison: Mpumalanga VS Western Cape",
            legend: 'bottom',
            colors: ['black', 'white', 'yellow', 'brown', 'blue', '#ffffff'],
            backgroundColor: 'gray',
            hAxis: {
