...
<script>
    ...
    function drawVisualization() {
        ...
        var data = google.visualization.arrayToDataTable([
            ['Population', 'Free State', {role: 'annotation'}, 'Gauteng', {role: 'annotation'}],
            ['', 2745590, '2 745 590', 12272263, '12 272 263']
        ]);
        var chart = new google.visualization.ColumnChart(document.getElementById('population'));
        var options = {
            title: "Population comparison: Free State VS Gauteng",
            legend: 'bottom',
...
<script>
    ...
    function drawVisualization() {
        // Create and populate the data table.
        var data = google.visualization.arrayToDataTable([
            ['Gender', 'Free State', {role: 'annotation'}, 'Gauteng', {role: 'annotation'}],
            ['Male', 48.5, '48.5%', 50.5, '50.5%'],
            ['Female', 51.5, '51.5%', 49.5, '49.5%']
        ]);
        var chart = new google.visualization.ColumnChart(document.getElementById('gender'));
        var options = {
            title: "Gender comparison: Free State VS Gauteng",
            legend: 'bottom',
            colors: ['black', 'white', 'yellow', 'brown', 'blue', '#ffffff'],
            backgroundColor: 'gray',
            hAxis: {
...
<script>
    ...
    function drawVisualization() {
        ...
        var data = google.visualization.arrayToDataTable([
            ['Population', 'Free State', {role: 'annotation'}, 'Gauteng', {role: 'annotation'}],
            ['', 21.1, 21.1, 675.1, 675.1]
        ]);
        var chart = new google.visualization.ColumnChart(document.getElementById('density'));
        var options = {
            title: "Population Density comparison: Free State VS Gauteng",
            legend: 'bottom',
            colors: ['black', 'white', 'yellow', 'brown', 'blue', '#ffffff'],
            backgroundColor: 'gray',
            hAxis: {
...
<script>
    ...
    function drawVisualization() {
        // Create and populate the data table.
        var data = google.visualization.arrayToDataTable([
            ['Race', 'Free State', {role: 'annotation'}, 'Gauteng', {role: 'annotation'}],
            ['Black', 2405137, '2 405 137', 9498732, '9 498 732'],
            ['White', 238866, '238 866', 1914473, '1 914 473'],
            ['Indian/Asian', 10982, '10 982', 355896, '355 896'],
            ['Coloured', 85113, '85 113', 429529, '429 529'],
            ['Other', 8237, '8 237', 85906, '85 906']
        ]);
        var chart = new google.visualization.ColumnChart(document.getElementById('race'));
        var options = {
            title: "Race comparison: Free State VS Gauteng",
            legend: 'bottom',
            colors: ['black', 'white', 'yellow', 'brown', 'blue', '#ffffff'],
            backgroundColor: 'gray',
            hAxis: {
...
<script>
    ...
    function drawVisualization() {
        ...
        var data = google.visualization.arrayToDataTable([
            ['Population', 'Free State', {role: 'annotation'}, 'Gauteng', {role: 'annotation'}],
            ['', 75312, 'R75 312', 156243, 'R156 243']
        ]);
        var chart = new google.visualization.ColumnChart(document.getElementById('income'));
        var options = {
            title: "Income comparison: Free State VS Gauteng",
            legend: 'bottom',
            colors: ['#BC6C04', '#4EBC03', 'yellow', 'brown', 'blue', '#ffffff'],
            backgroundColor: 'gray',
            hAxis: {
                title: ""
            },
...
<script>
    ...
    function drawVisualization() {
        ...
        var options = {
            title: "Matric Pass Rate comparison: Free State VS Gauteng",
            legend: 'bottom',
            colors: ['black', 'white', 'yellow', 'brown', 'blue', '#ffffff'],
            backgroundColor: 'gray',
            hAxis: {
