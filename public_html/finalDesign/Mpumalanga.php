...
<script type="text/javascript">
    ...
    function drawChart() {
        ...
        var options = {
            title: 'Population of Mpumalanga VS the rest of SA',
            legend: 'bottom',
...
<script type="text/javascript">
    ...
    function drawChart() {
        ...
        var options = {
            title: 'Size (km) of Mpumalanga VS the rest of SA',
            legend: 'bottom',
            backgroundColor: 'gray',
            width: 450,
            height: 225
...
<script>
    ...
    function drawVisualization() {
        ...
        var options = {
            title: "Median Age of Mpumalanga VS South Africa",
            legend: 'bottom',
            //colors: ['black', 'white', 'brown', 'yellow', '#eee', '#ffffff'],
            backgroundColor: 'gray',
            hAxis: {
...
<script>
    ...
    function drawVisualization() {
        ...
        var data = google.visualization.arrayToDataTable([
            ...
            ['', 3664225, '3 664 224', 302995, '302 995', 28280, '28 280', 36359, '36 359', 8080, '8 080']
        ]);
        var chart = new google.visualization.BarChart(document.getElementById('race'));
        var options = {
            title: "Race breakdown of Mpumalanga",
            legend: 'bottom',
...
<div style = "float: left;">
    ...
    <img src="Mpumalanga.png" style="vertical-align: middle; width: 516px; height: 341px;"/>
...
<div>
    ...
    <div style="height: 90%; overflow: scroll">
        <a href="ecVSm.php"><img src="Eastern Cape.png" class="compareBox"/></a>
        <h4 style="margin-left:50px;">Eastern Cape</h4>
        <a href="fsVSm.php"><img src="Free State.png" class="compareBox"/></a>
        <h4 style="margin-left:50px;">Free State</h4>
        <a href="gVSm.php"><img src="Gauteng.png" class="compareBox"/></a>
        <h4 style="margin-left:50px;">Gauteng</h4>
        <a href="kznVSm.php"><img src="KwaZulu-Natal.png" class="compareBox"/></a>
        <h4 style="margin-left:50px;">KwaZulu-Natal</h4>
        <a href="lVSm.php"><img src="Limpopo.png" class="compareBox"/></a>
        <h4 style="margin-left:50px;">Limpopo</h4>
        <a href="mVSnw.php"><img src="North West.png" class="compareBox"/></a>
        <h4 style="margin-left:50px;">North West</h4>
        <a href="mVSnc.php"><img src="Northern Cape.png" class="compareBox"/></a>
        <h4 style="margin-left:50px;">Northern Cape</h4>
        <a href="mVSwc.php"><img src="Western Cape.png" class="compareBox"/></a>
