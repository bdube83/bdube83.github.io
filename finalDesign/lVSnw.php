...
<script>
    ...
    function drawVisualization() {
        ...
        var data = google.visualization.arrayToDataTable([
            ['Population', 'Limpopo', {role: 'annotation'}, 'North West', {role: 'annotation'}],
            ['', 5404868, '5 404 868', 3509953, '3 509 953']
        ]);
        var chart = new google.visualization.ColumnChart(document.getElementById('population'));
        var options = {
            title: "Population comparison: Limpopo VS North West",
            legend: 'bottom',
...
<script>
    ...
    function drawVisualization() {
        // Create and populate the data table.
        var data = google.visualization.arrayToDataTable([
            ['Gender', 'Limpopo', {role: 'annotation'}, 'North West', {role: 'annotation'}],
            ['Male', 46.8, '46.8%', 50.7, '50.7%'],
            ['Female', 53.2, '53.2%', 49.3, '49.3%']
        ]);
        var chart = new google.visualization.ColumnChart(document.getElementById('gender'));
        var options = {
            title: "Gender comparison: Limpopo VS North West",
            legend: 'bottom',
            colors: ['black', 'white', 'yellow', 'brown', 'blue', '#ffffff'],
            backgroundColor: 'gray',
            hAxis: {
...
<script>
    ...
    function drawVisualization() {
        ...
        var options = {
            title: "Population Density comparison: Limpopo VS North West",
            legend: 'bottom',
            colors: ['black', 'white', 'yellow', 'brown', 'blue', '#ffffff'],
            backgroundColor: 'gray',
            hAxis: {
...
<script>
    ...
    function drawVisualization() {
        // Create and populate the data table.
        var data = google.visualization.arrayToDataTable([
            ['Race', 'Limpopo', {role: 'annotation'}, 'North West', {role: 'annotation'}],
            ['Black', 5226507, '5 226 507', 3151938, '3 151 938'],
            ['White', 140527, '140 527', 256227, '256 227'],
            ['Indian/Asian', 16215, '16 215', 21060, '21 060'],
            ['Coloured', 16215, '16 215', 70199, '70 199'],
            ['Other', 10810, '10 810', 10530, '10 530']
        ]);
        var chart = new google.visualization.ColumnChart(document.getElementById('race'));
        var options = {
            title: "Race comparison: Limpopo VS North West",
            legend: 'bottom',
            colors: ['black', 'white', 'yellow', 'brown', 'blue', '#ffffff'],
            backgroundColor: 'gray',
            hAxis: {
...
<script>
    ...
    function drawVisualization() {
        ...
        var data = google.visualization.arrayToDataTable([
            ['Population', 'Limpopo', {role: 'annotation'}, 'North West', {role: 'annotation'}],
            ['', 56844, 'R56 844', 69955, 'R69 955']
        ]);
        var chart = new google.visualization.ColumnChart(document.getElementById('income'));
        var options = {
            title: "Income comparison: Limpopo VS North West",
            legend: 'bottom',
            colors: ['#B30A05', '#BC4B07', 'yellow', 'brown', 'blue', '#ffffff'],
            backgroundColor: 'gray',
            hAxis: {
                title: ""
            },
...
<script>
    ...
    function drawVisualization() {
        ...
        var options = {
            title: "Matric Pass Rate comparison: Limpopo VS North West",
            legend: 'bottom',
            colors: ['black', 'white', 'yellow', 'brown', 'blue', '#ffffff'],
            backgroundColor: 'gray',
            hAxis: {
