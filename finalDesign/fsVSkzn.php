...
<script>
    ...
    function drawVisualization() {
        ...
        var data = google.visualization.arrayToDataTable([
            ['Population', 'Free State', {role: 'annotation'}, 'KwaZulu-Natal', {role: 'annotation'}],
            ['', 2745590, '2 745 590', 10267300, '10 267 300']
        ]);
        var chart = new google.visualization.ColumnChart(document.getElementById('population'));
        var options = {
            title: "Population comparison: Free State VS KwaZulu-Natal",
            legend: 'bottom',
...
<script>
    ...
    function drawVisualization() {
        ...
        var data = google.visualization.arrayToDataTable([
            ['Population', 'Free State', {role: 'annotation'}, 'KwaZulu-Natal', {role: 'annotation'}],
            ['', 129825, '129 825', 94361, '94 361']
        ]);
        var chart = new google.visualization.ColumnChart(document.getElementById('size'));
        var options = {
            title: "Size comparison: Free State VS KwaZulu-Natal",
            legend: 'bottom',
            colors: ['black', 'white', 'yellow', 'brown', 'blue', '#ffffff'],
            backgroundColor: 'gray',
            hAxis: {
...
<script>
    ...
    function drawVisualization() {
        // Create and populate the data table.
        var data = google.visualization.arrayToDataTable([
            ['Gender', 'Free State', {role: 'annotation'}, 'KwaZulu-Natal', {role: 'annotation'}],
        ...
        var options = {
            title: "Gender comparison: Free State VS KwaZulu-Natal",
            legend: 'bottom',
            colors: ['black', 'white', 'yellow', 'brown', 'blue', '#ffffff'],
            backgroundColor: 'gray',
            hAxis: {
...
<script>
    ...
    function drawVisualization() {
        ...
        var data = google.visualization.arrayToDataTable([
            ['Population', 'Free State', {role: 'annotation'}, 'KwaZulu-Natal', {role: 'annotation'}],
            ['', 21.1, 21.1, 108.8, 108.8]
        ]);
        var chart = new google.visualization.ColumnChart(document.getElementById('density'));
        var options = {
            title: "Population Density comparison: Free State VS KwaZulu-Natal",
            legend: 'bottom',
            colors: ['black', 'white', 'yellow', 'brown', 'blue', '#ffffff'],
            backgroundColor: 'gray',
            hAxis: {
...
<script>
    ...
    function drawVisualization() {
        // Create and populate the data table.
        var data = google.visualization.arrayToDataTable([
            ['Race', 'Free State', {role: 'annotation'}, 'KwaZulu-Natal', {role: 'annotation'}],
            ['Black', 2405137, '2 405 137', 8912016, '8 912 016'],
            ['White', 238866, '238 866', 431227, '431 227'],
            ['Indian/Asian', 10982, '10 982', 759780, '759 780'],
            ['Coloured', 85113, '85 113', 143742, '143 742'],
            ['Other', 8237, '8 237', 30802, '30 802']
        ]);
        var chart = new google.visualization.ColumnChart(document.getElementById('race'));
        var options = {
            title: "Race comparison: Free State VS KwaZulu-Natal",
            legend: 'bottom',
            colors: ['black', 'white', 'yellow', 'brown', 'blue', '#ffffff'],
            backgroundColor: 'gray',
            hAxis: {
...
<script>
    ...
    function drawVisualization() {
        ...
        var data = google.visualization.arrayToDataTable([
            ['Population', 'Free State', {role: 'annotation'}, 'KwaZulu-Natal', {role: 'annotation'}],
            ['', 75312, 'R75 312', 83053, 'R83 053']
        ]);
        var chart = new google.visualization.ColumnChart(document.getElementById('income'));
        var options = {
            title: "Income comparison: Free State VS KwaZulu-Natal",
            legend: 'bottom',
            colors: ['#BC6C04', '#B8BC06', 'yellow', 'brown', 'blue', '#ffffff'],
            backgroundColor: 'gray',
            hAxis: {
                title: ""
            },
...
<script>
    ...
    function drawVisualization() {
        ...
        var options = {
            title: "Matric Pass Rate comparison: Free State VS KwaZulu-Natal",
            legend: 'bottom',
            colors: ['black', 'white', 'yellow', 'brown', 'blue', '#ffffff'],
            backgroundColor: 'gray',
            hAxis: {
