...
<script>
    ...
    function drawVisualization() {
        ...
        var data = google.visualization.arrayToDataTable([
            ['Population', 'Limpopo', {role: 'annotation'}, 'Northern Cape', {role: 'annotation'}],
            ['', 5404868, '5 404 868', 1145861, '1 145 861']
        ]);
        var chart = new google.visualization.ColumnChart(document.getElementById('population'));
        var options = {
            title: "Population comparison: Limpopo VS Northern Cape",
            legend: 'bottom',
...
<script>
    ...
    function drawVisualization() {
        ...
        var data = google.visualization.arrayToDataTable([
            ['Population', 'Limpopo', {role: 'annotation'}, 'Northern Cape', {role: 'annotation'}],
            ['', 125754, '125 754', 372889, '372 889']
        ]);
        var chart = new google.visualization.ColumnChart(document.getElementById('size'));
        var options = {
            title: "Size comparison: Limpopo VS Northern Cape",
            legend: 'bottom',
            colors: ['black', 'white', 'yellow', 'brown', 'blue', '#ffffff'],
            backgroundColor: 'gray',
            hAxis: {
...
<script>
    ...
    function drawVisualization() {
        // Create and populate the data table.
        var data = google.visualization.arrayToDataTable([
            ['Gender', 'Limpopo', {role: 'annotation'}, 'Northern Cape', {role: 'annotation'}],
            ['Male', 46.8, '46.8%', 49.2, '49.2%'],
            ['Female', 53.2, '53.2%', 50.8, '50.8%']
        ]);
        var chart = new google.visualization.ColumnChart(document.getElementById('gender'));
        var options = {
            title: "Gender comparison: Limpopo VS Northern Cape",
            legend: 'bottom',
            colors: ['black', 'white', 'yellow', 'brown', 'blue', '#ffffff'],
            backgroundColor: 'gray',
            hAxis: {
...
<script>
    ...
    function drawVisualization() {
        ...
        var options = {
            title: "Population Density comparison: Limpopo VS Northern Cape",
            legend: 'bottom',
            colors: ['black', 'white', 'yellow', 'brown', 'blue', '#ffffff'],
            backgroundColor: 'gray',
            hAxis: {
...
<script>
    ...
    function drawVisualization() {
        // Create and populate the data table.
        var data = google.visualization.arrayToDataTable([
            ['Race', 'Limpopo', {role: 'annotation'}, 'Northern Cape', {role: 'annotation'}],
            ['Black', 5226507, '5 226 507', 577514, '577 514'],
            ['White', 140527, '140 527', 81356, '81 356'],
            ['Indian/Asian', 16215, '16 215', 8021, '8 021'],
            ['Coloured', 16215, '16 215', 461782, '461 782'],
            ['Other', 10810, '10 810', 18334, '18 334']
        ]);
        var chart = new google.visualization.ColumnChart(document.getElementById('race'));
        var options = {
            title: "Race comparison: Limpopo VS Northern Cape",
            legend: 'bottom',
            colors: ['black', 'white', 'yellow', 'brown', 'blue', '#ffffff'],
            backgroundColor: 'gray',
            hAxis: {
...
<script>
    ...
    function drawVisualization() {
        ...
        var data = google.visualization.arrayToDataTable([
            ['Population', 'Limpopo', {role: 'annotation'}, 'Northern Cape', {role: 'annotation'}],
            ['', 56844, 'R56 844', 86175, 'R86 175']
        ]);
        var chart = new google.visualization.ColumnChart(document.getElementById('income'));
        var options = {
            title: "Income comparison: Limpopo VS Northern Cape",
            legend: 'bottom',
            colors: ['#B30A05', '#9BBC05', 'yellow', 'brown', 'blue', '#ffffff'],
            backgroundColor: 'gray',
            hAxis: {
                title: ""
            },
...
<script>
    ...
    function drawVisualization() {
        ...
        var options = {
            title: "Matric Pass Rate comparison: Limpopo VS Northern Cape",
            legend: 'bottom',
            colors: ['black', 'white', 'yellow', 'brown', 'blue', '#ffffff'],
            backgroundColor: 'gray',
            hAxis: {
