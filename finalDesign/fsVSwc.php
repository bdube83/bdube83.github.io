...
<script>
    ...
    function drawVisualization() {
        ...
        var data = google.visualization.arrayToDataTable([
            ['Population', 'Free State', {role: 'annotation'}, 'Western Cape', {role: 'annotation'}],
            ['', 2745590, '2 745 590', 5822734, '5 822 734']
        ]);
        var chart = new google.visualization.ColumnChart(document.getElementById('population'));
        var options = {
            title: "Population comparison: Free State VS Western Cape",
            legend: 'bottom',
...
<script>
    ...
    function drawVisualization() {
        ...
        var data = google.visualization.arrayToDataTable([
            ['Population', 'Free State', {role: 'annotation'}, 'Western Cape', {role: 'annotation'}],
            ['', 129825, '129 825', 129462, '129 462']
        ]);
        var chart = new google.visualization.ColumnChart(document.getElementById('size'));
        var options = {
            title: "Size comparison: Free State VS Western Cape",
            legend: 'bottom',
            colors: ['black', 'white', 'yellow', 'brown', 'blue', '#ffffff'],
            backgroundColor: 'gray',
            hAxis: {
...
<script>
    ...
    function drawVisualization() {
        // Create and populate the data table.
        var data = google.visualization.arrayToDataTable([
            ['Gender', 'Free State', {role: 'annotation'}, 'Western Cape', {role: 'annotation'}],
            ['Male', 48.5, '48.5%', 49.0, '49.0%'],
            ['Female', 51.5, '51.5%', 51.0, '51.0%']
        ]);
        var chart = new google.visualization.ColumnChart(document.getElementById('gender'));
        var options = {
            title: "Gender comparison: Free State VS Western Cape",
            legend: 'bottom',
            colors: ['black', 'white', 'yellow', 'brown', 'blue', '#ffffff'],
            backgroundColor: 'gray',
            hAxis: {
...
<script>
    ...
    function drawVisualization() {
        ...
        var options = {
            title: "Population Density comparison: Free State VS Western Cape",
            legend: 'bottom',
            colors: ['black', 'white', 'yellow', 'brown', 'blue', '#ffffff'],
            backgroundColor: 'gray',
            hAxis: {
...
<script>
    ...
    function drawVisualization() {
        // Create and populate the data table.
        var data = google.visualization.arrayToDataTable([
            ['Race', 'Free State', {role: 'annotation'}, 'Western Cape', {role: 'annotation'}],
            ['Black', 2405137, '2 405 137', 1915679, '1 915 679'],
            ['White', 238866, '238 866', 914169, '914 169'],
            ['Indian/Asian', 10982, '10 982', 58227, '58 227'],
            ['Coloured', 85113, '85 113', 2841494, '2 841 494'],
            ['Other', 8237, '8 237', 93164, '93 164']
        ]);
        var chart = new google.visualization.ColumnChart(document.getElementById('race'));
        var options = {
            title: "Race comparison: Free State VS Western Cape",
            legend: 'bottom',
            colors: ['black', 'white', 'yellow', 'brown', 'blue', '#ffffff'],
            backgroundColor: 'gray',
            hAxis: {
...
<script>
    ...
    function drawVisualization() {
        ...
        var data = google.visualization.arrayToDataTable([
            ['Population', 'Free State', {role: 'annotation'}, 'Western Cape', {role: 'annotation'}],
            ['', 75312, 'R75 312', 143460, 'R143 460']
        ]);
        var chart = new google.visualization.ColumnChart(document.getElementById('income'));
        var options = {
            title: "Income comparison: Free State VS Western Cape",
            legend: 'bottom',
            colors: ['#BC6C04', '#7ABD03', 'yellow', 'brown', 'blue', '#ffffff'],
            backgroundColor: 'gray',
            hAxis: {
                title: ""
            },
...
<script>
    ...
    function drawVisualization() {
        ...
        var options = {
            title: "Matric Pass Rate comparison: Free State VS Western Cape",
            legend: 'bottom',
            colors: ['black', 'white', 'yellow', 'brown', 'blue', '#ffffff'],
            backgroundColor: 'gray',
            hAxis: {
