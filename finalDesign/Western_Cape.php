...
<script type="text/javascript">
    ...
    function drawChart() {
        ...
        var options = {
            title: 'Population of Western Cape VS the rest of SA',
            legend: 'bottom',
...
<script type="text/javascript">
    ...
    function drawChart() {
        ...
        var options = {
            title: 'Size (km) of Western Cape VS the rest of SA',
            legend: 'bottom',
            backgroundColor: 'gray',
            width: 450,
            height: 225
...
<script>
    ...
    function drawVisualization() {
        ...
        var options = {
            title: "Median Age of Western Cape VS South Africa",
            legend: 'bottom',
            //colors: ['black', 'white', 'brown', 'yellow', '#eee', '#ffffff'],
            backgroundColor: 'gray',
            hAxis: {
...
<script>
    ...
    function drawVisualization() {
        ...
        var data = google.visualization.arrayToDataTable([
            ...
            ['', 1915679, '1 915 679', 914169, '914 169', 58227, '58 227', 2841494, '2 841 494', 93164, '93 164']
        ]);
        var chart = new google.visualization.BarChart(document.getElementById('race'));
        var options = {
            title: "Race breakdown of Western Cape",
            legend: 'bottom',
...
<div style="position: absolute; top: 20px; left: 540px; z-index: 1;">
...
<div style = "float: left;">
    ...
    <img src="Western Cape.png" style="vertical-align: middle; width: 516px; height: 341px;"/>
...
<div>
    ...
    <div style="height: 90%; overflow: scroll">
        <a href="ecVSwc.php"><img src="Eastern Cape.png" class="compareBox"/></a>
        <h4 style="margin-left:50px;">Eastern Cape</h4>
        <a href="fsVSwc.php"><img src="Free State.png" class="compareBox"/></a>
        <h4 style="margin-left:50px;">Free State</h4>
        <a href="gVSwc.php"><img src="Gauteng.png" class="compareBox"/></a>
        <h4 style="margin-left:50px;">Gauteng</h4>
        <a href="kznVSwc.php"><img src="KwaZulu-Natal.png" class="compareBox"/></a>
        <h4 style="margin-left:50px;">KwaZulu-Natal</h4>
        <a href="lVSwc.php"><img src="Limpopo.png" class="compareBox"/></a>
        <h4 style="margin-left:50px;">Limpopo</h4>
        <a href="mVSwc.php"><img src="Mpumalanga.png" class="compareBox"/></a>
        <h4 style="margin-left:50px;">Mpumalanga</h4>
        <a href="nwVSwc.php"><img src="North West.png" class="compareBox"/></a>
        <h4 style="margin-left:50px;">North West</h4>
        <a href="ncVSwc.php"><img src="Northern Cape.png" class="compareBox"/></a>
