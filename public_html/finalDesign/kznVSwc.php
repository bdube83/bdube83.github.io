...
<script>
    ...
    function drawVisualization() {
        ...
        var data = google.visualization.arrayToDataTable([
            ['Population', 'KwaZulu-Natal', {role: 'annotation'}, 'Western Cape', {role: 'annotation'}],
            ['', 10267300, '10 267 300', 5822734, '5 822 734']
        ]);
        var chart = new google.visualization.ColumnChart(document.getElementById('population'));
        var options = {
            title: "Population comparison: KwaZulu-Natal VS Western Cape",
            legend: 'bottom',
...
<script>
    ...
    function drawVisualization() {
        ...
        var data = google.visualization.arrayToDataTable([
            ['Population', 'KwaZulu-Natal', {role: 'annotation'}, 'Western Cape', {role: 'annotation'}],
            ['', 94361, '94 361', 129462, '129 462']
        ]);
        var chart = new google.visualization.ColumnChart(document.getElementById('size'));
        var options = {
            title: "Size comparison: KwaZulu-Natal VS Western Cape",
            legend: 'bottom',
            colors: ['black', 'white', 'yellow', 'brown', 'blue', '#ffffff'],
            backgroundColor: 'gray',
            hAxis: {
...
<script>
    ...
    function drawVisualization() {
        // Create and populate the data table.
        var data = google.visualization.arrayToDataTable([
            ['Gender', 'KwaZulu-Natal', {role: 'annotation'}, 'Western Cape', {role: 'annotation'}],
            ['Male', 47.6, '47.6%', 49.0, '49.0%'],
            ['Female', 52.4, '52.4%', 51.0, '51.0%']
        ]);
        var chart = new google.visualization.ColumnChart(document.getElementById('gender'));
        var options = {
            title: "Gender comparison: KwaZulu-Natal VS Western Cape",
            legend: 'bottom',
            colors: ['black', 'white', 'yellow', 'brown', 'blue', '#ffffff'],
            backgroundColor: 'gray',
            hAxis: {
...
<script>
    ...
    function drawVisualization() {
        ...
        var data = google.visualization.arrayToDataTable([
            ['Population', 'KwaZulu-Natal', {role: 'annotation'}, 'Western Cape', {role: 'annotation'}],
            ['', 108.8, 108.8, 45.0, 45.0]
        ]);
        var chart = new google.visualization.ColumnChart(document.getElementById('density'));
        var options = {
            title: "Population Density comparison: KwaZulu-Natal VS Western Cape",
            legend: 'bottom',
            colors: ['black', 'white', 'yellow', 'brown', 'blue', '#ffffff'],
            backgroundColor: 'gray',
            hAxis: {
...
<script>
    ...
    function drawVisualization() {
        // Create and populate the data table.
        var data = google.visualization.arrayToDataTable([
            ['Race', 'KwaZulu-Natal', {role: 'annotation'}, 'Western Cape', {role: 'annotation'}],
            ['Black', 8912016, '8 912 016', 1915679, '1 915 679'],
            ['White', 431227, '431 227', 914169, '914 169'],
            ['Indian/Asian', 759780, '759 780', 58227, '58 227'],
            ['Coloured', 143742, '143 742', 2841494, '2 841 494'],
            ['Other', 30802, '30 802', 93164, '93 164']
        ]);
        var chart = new google.visualization.ColumnChart(document.getElementById('race'));
        var options = {
            title: "Race comparison: KwaZulu-Natal VS Western Cape",
            legend: 'bottom',
            colors: ['black', 'white', 'yellow', 'brown', 'blue', '#ffffff'],
            backgroundColor: 'gray',
            hAxis: {
...
<script>
    ...
    function drawVisualization() {
        ...
        var data = google.visualization.arrayToDataTable([
            ['Population', 'KwaZulu-Natal', {role: 'annotation'}, 'Western Cape', {role: 'annotation'}],
            ['', 83053, 'R83 053', 143460, 'R143 460']
        ]);
        var chart = new google.visualization.ColumnChart(document.getElementById('income'));
        var options = {
            title: "Income comparison: KwaZulu-Natal VS Western Cape",
            legend: 'bottom',
            colors: ['#B8BC06', '#7ABD03', 'yellow', 'brown', 'blue', '#ffffff'],
            backgroundColor: 'gray',
            hAxis: {
                title: ""
            },
...
<script>
    ...
    function drawVisualization() {
        ...
        var options = {
            title: "Matric Pass Rate comparison: KwaZulu-Natal VS Western Cape",
            legend: 'bottom',
            colors: ['black', 'white', 'yellow', 'brown', 'blue', '#ffffff'],
            backgroundColor: 'gray',
            hAxis: {
