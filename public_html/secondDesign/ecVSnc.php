...
<script>
    ...
    function drawVisualization() {
        ...
        var data = google.visualization.arrayToDataTable([
            ['Population', 'Eastern Cape', {role: 'annotation'}, 'Northern Cape', {role: 'annotation'}],
            ['', 6562053, '6 562 053', 1145861, '1 145 861']
        ]);
        var chart = new google.visualization.ColumnChart(document.getElementById('population'));
        var options = {
            title: "Population comparion: Eastern Cape VS Northern Cape",
            legend: 'bottom',
...
<script>
    ...
    function drawVisualization() {
        ...
        var data = google.visualization.arrayToDataTable([
            ['Population', 'Eastern Cape', {role: 'annotation'}, 'Northern Cape', {role: 'annotation'}],
            ['', 168966, '168 966', 372889, '372 889']
        ]);
        var chart = new google.visualization.ColumnChart(document.getElementById('size'));
        var options = {
            title: "Size comparion: Eastern Cape VS Northern Cape",
            legend: 'bottom',
            colors: ['black', 'white', 'yellow', 'brown', 'blue', '#ffffff'],
            backgroundColor: 'gray',
            hAxis: {
...
<script>
    ...
    function drawVisualization() {
        // Create and populate the data table.
        var data = google.visualization.arrayToDataTable([
            ['Gender', 'Eastern Cape', {role: 'annotation'}, 'Northern Cape', {role: 'annotation'}],
            ['Male', 47.1, '47.1%', 49.2, '49.2%'],
            ['Female', 52.9, '52.9%', 50.8, '50.8%']
        ]);
        var chart = new google.visualization.ColumnChart(document.getElementById('gender'));
        var options = {
            title: "Gender comparion: Eastern Cape VS Northern Cape",
            legend: 'bottom',
            colors: ['black', 'white', 'yellow', 'brown', 'blue', '#ffffff'],
            backgroundColor: 'gray',
            hAxis: {
...
<script>
    ...
    function drawVisualization() {
        ...
        var options = {
            title: "Population Density comparion: Eastern Cape VS Northern Cape",
            legend: 'bottom',
            colors: ['black', 'white', 'yellow', 'brown', 'blue', '#ffffff'],
            backgroundColor: 'gray',
            hAxis: {
...
<script>
    ...
    function drawVisualization() {
        // Create and populate the data table.
        var data = google.visualization.arrayToDataTable([
            ['Race', 'Eastern Cape', {role: 'annotation'}, 'Northern Cape', {role: 'annotation'}],
            ['Black', 5663051, '5 663 051', 577514, '577 514'],
            ['White', 308417, '308 417', 81356, '81 356'],
            ['Indian/Asian', 26248, '26 248', 8021, '8 021'],
            ['Coloured', 544650, '544 650', 461781, '461 781'],
            ['Other', 19686, '19 686', 18334, '18 334']
        ]);
        var chart = new google.visualization.ColumnChart(document.getElementById('race'));
        var options = {
            title: "Race comparion: Eastern Cape VS Northern Cape",
            legend: 'bottom',
            colors: ['black', 'white', 'yellow', 'brown', 'blue', '#ffffff'],
            backgroundColor: 'gray',
            hAxis: {
...
<script>
    ...
    function drawVisualization() {
        ...
        var data = google.visualization.arrayToDataTable([
            ['Population', 'Eastern Cape', {role: 'annotation'}, 'Northern Cape', {role: 'annotation'}],
            ['', 64539, 'R64 539', 86175, 'R86 175']
        ]);
        var chart = new google.visualization.ColumnChart(document.getElementById('income'));
        var options = {
            title: "Income comparion: Eastern Cape VS Northern Cape",
            legend: 'bottom',
            colors: ['black', 'white', 'yellow', 'brown', 'blue', '#ffffff'],
            backgroundColor: 'gray',
            hAxis: {
...
<script>
    ...
    function drawVisualization() {
        ...
        var options = {
            title: "Matric Pass Rate comparion: Eastern Cape VS Northern Cape",
            legend: 'bottom',
            colors: ['black', 'white', 'yellow', 'brown', 'blue', '#ffffff'],
            backgroundColor: 'gray',
            hAxis: {
