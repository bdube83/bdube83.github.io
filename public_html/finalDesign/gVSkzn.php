...
<script>
    ...
    function drawVisualization() {
        ...
        var data = google.visualization.arrayToDataTable([
            ['Population', 'Gauteng', {role: 'annotation'}, 'KwaZulu-Natal', {role: 'annotation'}],
            ['', 12272263, '12 272 263', 10267300, '10 267 300']
        ]);
        var chart = new google.visualization.ColumnChart(document.getElementById('population'));
        var options = {
            title: "Population comparison: Gauteng VS KwaZulu-Natal",
            legend: 'bottom',
...
<script>
    ...
    function drawVisualization() {
        // Create and populate the data table.
        var data = google.visualization.arrayToDataTable([
            ['Gender', 'Gauteng', {role: 'annotation'}, 'KwaZulu-Natal', {role: 'annotation'}],
            ['Male', 50.5, '50.5%', 47.6, '47.6%'],
            ['Female', 49.5, '49.5%', 52.4, '52.4%']
        ]);
        var chart = new google.visualization.ColumnChart(document.getElementById('gender'));
        var options = {
            title: "Gender comparison: Gauteng VS KwaZulu-Natal",
            legend: 'bottom',
            colors: ['black', 'white', 'yellow', 'brown', 'blue', '#ffffff'],
            backgroundColor: 'gray',
            hAxis: {
...
<script>
    ...
    function drawVisualization() {
        ...
        var data = google.visualization.arrayToDataTable([
            ['Population', 'Gauteng', {role: 'annotation'}, 'KwaZulu-Natal', {role: 'annotation'}],
            ['', 675.1, 675.1, 108.8, 108.8]
        ]);
        var chart = new google.visualization.ColumnChart(document.getElementById('density'));
        var options = {
            title: "Population Density comparison: Gauteng VS KwaZulu-Natal",
            legend: 'bottom',
            colors: ['black', 'white', 'yellow', 'brown', 'blue', '#ffffff'],
            backgroundColor: 'gray',
            hAxis: {
...
<script>
    ...
    function drawVisualization() {
        // Create and populate the data table.
        var data = google.visualization.arrayToDataTable([
            ['Race', 'Gauteng', {role: 'annotation'}, 'KwaZulu-Natal', {role: 'annotation'}],
            ['Black', 9498732, '9 498 732', 8912016, '8 912 016'],
            ['White', 1914473, '1 914 473', 431227, '431 227'],
            ['Indian/Asian', 355896, '355 896', 759780, '759 780'],
            ['Coloured', 429529, '429 529', 143742, '143 742'],
            ['Other', 85906, '85 906', 30802, '30 802']
        ]);
        var chart = new google.visualization.ColumnChart(document.getElementById('race'));
        var options = {
            title: "Race comparison: Gauteng VS KwaZulu-Natal",
            legend: 'bottom',
            colors: ['black', 'white', 'yellow', 'brown', 'blue', '#ffffff'],
            backgroundColor: 'gray',
            hAxis: {
...
<script>
    ...
    function drawVisualization() {
        ...
        var data = google.visualization.arrayToDataTable([
            ['Population', 'Gauteng', {role: 'annotation'}, 'KwaZulu-Natal', {role: 'annotation'}],
            ['', 156243, 'R156 243', 83053, 'R83 053']
        ]);
        var chart = new google.visualization.ColumnChart(document.getElementById('income'));
        var options = {
            title: "Income comparison: Gauteng VS KwaZulu-Natal",
            legend: 'bottom',
            colors: ['#4EBC03', '#B8BC06', 'yellow', 'brown', 'blue', '#ffffff'],
            backgroundColor: 'gray',
            hAxis: {
                title: ""
            },
...
<script>
    ...
    function drawVisualization() {
        ...
        var options = {
            title: "Matric Pass Rate comparison: Gauteng VS KwaZulu-Natal",
            legend: 'bottom',
            colors: ['black', 'white', 'yellow', 'brown', 'blue', '#ffffff'],
            backgroundColor: 'gray',
            hAxis: {
