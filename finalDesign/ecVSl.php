...
<script>
    ...
    function drawVisualization() {
        ...
        var data = google.visualization.arrayToDataTable([
            ['Population', 'Eastern Cape', {role: 'annotation'}, 'Limpopo', {role: 'annotation'}],
            ['', 6562053, '6 562 053', 5404868, '5 404 868']
        ]);
        var chart = new google.visualization.ColumnChart(document.getElementById('population'));
        var options = {
            title: "Population comparison: Eastern Cape VS Limpopo",
            legend: 'bottom',
...
<script>
    ...
    function drawVisualization() {
        // Create and populate the data table.
        var data = google.visualization.arrayToDataTable([
            ['Gender', 'Eastern Cape', {role: 'annotation'}, 'Limpopo', {role: 'annotation'}],
            ['Male', 47.1, '47.1%', 46.8, '46.8%'],
            ['Female', 52.9, '52.9%', 53.2, '53.2%']
        ]);
        var chart = new google.visualization.ColumnChart(document.getElementById('gender'));
        var options = {
            title: "Gender comparison: Eastern Cape VS Limpopo",
            legend: 'bottom',
            colors: ['black', 'white', 'yellow', 'brown', 'blue', '#ffffff'],
            backgroundColor: 'gray',
            hAxis: {
...
<script>
    ...
    function drawVisualization() {
        ...
        var options = {
            title: "Population Density comparison: Eastern Cape VS Limpopo",
            legend: 'bottom',
            colors: ['black', 'white', 'yellow', 'brown', 'blue', '#ffffff'],
            backgroundColor: 'gray',
            hAxis: {
...
<script>
    ...
    function drawVisualization() {
        // Create and populate the data table.
        var data = google.visualization.arrayToDataTable([
            ['Race', 'Eastern Cape', {role: 'annotation'}, 'Limpopo', {role: 'annotation'}],
            ['Black', 5663051, '5 663 051', 5226507, '5 226 507'],
            ['White', 308417, '308 417', 140527, '140 527'],
            ['Indian/Asian', 26248, '26 248', 16215, '16 215'],
            ['Coloured', 544650, '544 650', 16215, '16 215'],
            ['Other', 19686, '19 686', 10810, '10 810']
        ]);
        var chart = new google.visualization.ColumnChart(document.getElementById('race'));
        var options = {
            title: "Race comparison: Eastern Cape VS Limpopo",
            legend: 'bottom',
            colors: ['black', 'white', 'yellow', 'brown', 'blue', '#ffffff'],
            backgroundColor: 'gray',
            hAxis: {
...
<script>
    ...
    function drawVisualization() {
        ...
        var data = google.visualization.arrayToDataTable([
            ['Population', 'Eastern Cape', {role: 'annotation'}, 'Limpopo', {role: 'annotation'}],
            ['', 64539, 'R64 539', 56844, 'R56 844']
        ]);
        var chart = new google.visualization.ColumnChart(document.getElementById('income'));
        var options = {
            title: "Income comparison: Eastern Cape VS Limpopo",
            legend: 'bottom',
            colors: ['#BB3003', '#B30A05', 'yellow', 'brown', 'blue', '#ffffff'],
            backgroundColor: 'gray',
            hAxis: {
                title: ""
            },
...
<script>
    ...
    function drawVisualization() {
        ...
        var options = {
            title: "Matric Pass Rate comparison: Eastern Cape VS Limpopo",
            legend: 'bottom',
            colors: ['black', 'white', 'yellow', 'brown', 'blue', '#ffffff'],
            backgroundColor: 'gray',
            hAxis: {
