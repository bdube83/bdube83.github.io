...
<div>
    ...
    <div style="height: 90%; overflow: scroll">
        <a href="ecVSfs.php"><img src="Free State.png" class="compareBox"/></a>
        <h4 style="margin-left:50px;">Free State</h4>
        <a href="ecVSg.php"><img src="Gauteng.png" class="compareBox"/></a>
        <h4 style="margin-left:50px;">Gauteng</h4>
        <a href="ecVSkzn.php"><img src="KwaZulu-Natal.png" class="compareBox"/></a>
        <h4 style="margin-left:50px;">KwaZulu-Natal</h4>
        <a href="ecVSl.php"><img src="Limpopo.png" class="compareBox"/></a>
        <h4 style="margin-left:50px;">Limpopo</h4>
        <a href="ecVSm.php"><img src="Mpumalanga.png" class="compareBox"/></a>
        <h4 style="margin-left:50px;">Mpumalanga</h4>
        <a href="ecVSnw.php"><img src="North West.png" class="compareBox"/></a>
        ...
        <a href="ecVSwc.php"><img src="Western Cape.png" class="compareBox"/></a>
